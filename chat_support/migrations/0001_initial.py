    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=13, unique=True, validators=[chat_support.validator.username_validator], verbose_name='табельный номер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dialog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dialog_messages', to='chat_support.chatdialog', verbose_name='диалог')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_actives', models.BooleanField(default=True, verbose_name='Активность')),
                ('dialog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='chat_support.chatdialog', verbose_name='диалог, который оцениваем')),
                ('rated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_rating', to=settings.AUTH_USER_MODEL, verbose_name='кем поизведена оценка')),
